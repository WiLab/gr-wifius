...
class top_block(gr.top_block, Qt.QWidget):
    ...
    def set_variable_qtgui_range_0_0(self, variable_qtgui_range_0_0):
        ...
        self.blocks_multiply_const_vxx_0_0.set_k((self.variable_qtgui_range_0_0*0.01, ))
    ...
    def set_variable_qtgui_chooser_0_1(self, variable_qtgui_chooser_0_1):
        ...
        self._variable_qtgui_chooser_0_1_callback(self.variable_qtgui_chooser_0_1)
        self.blocks_message_strobe_0.set_msg(pmt.from_double(self.variable_qtgui_chooser_0_1))
